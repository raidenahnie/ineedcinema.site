...
<head>
    ...
    <meta name="disclaimer"
        content="iNeedCinema does not host any files. All content is provided by third-party services. We do not own or distribute any content.">
    <meta name="copyright"
        content="All content belongs to their respective owners. Trademarks and logos are property of their respective companies.">
...
<body class="bg-zinc-950 text-white font-inter antialiased">
    <!-- Header -->
    <header
        class="fixed top-0 left-0 right-0 z-50 bg-gray-900/95 backdrop-blur-xl border-b border-gray-800/50 shadow-lg">
        <nav class="container mx-auto px-2 sm:px-4 py-1.5">
            <div class="flex items-center justify-between gap-8">
                <!-- Logo -->
                <a href="{{ route('home') }}" class="flex items-center space-x-2 sm:space-x-3 group flex-shrink-0">
                    <div
                        class="w-8 h-8 sm:w-10 sm:h-10 bg-gradient-to-br from-red-600 via-red-500 to-orange-500 rounded-xl flex items-center justify-center shadow-lg group-hover:shadow-red-500/50 transition-all duration-300 group-hover:scale-110">
                        <i class="fas fa-play text-white text-base sm:text-lg"></i>
                    </div>
                    <span
                        class="text-xl sm:text-2xl font-bold bg-gradient-to-r from-white to-gray-300 bg-clip-text text-transparent">iNeedCinema</span>
                </a>

                <!-- Navigation Menu -->
                <div class="hidden lg:flex items-center space-x-1">
                    <a href="{{ route('home') }}"
                        class="nav-link px-4 py-2 rounded-lg @if (request()->routeIs('home')) bg-red-500/10 text-red-500 @endif">
                        <i class="fas fa-home mr-2"></i>Home
                    </a>
                    <a href="{{ route('movies') }}"
                        class="nav-link px-4 py-2 rounded-lg @if (request()->routeIs('movies')) bg-red-500/10 text-red-500 @endif">
                        <i class="fas fa-film mr-2"></i>Movies
                    </a>
                    <a href="{{ route('tv-shows') }}"
                        class="nav-link px-4 py-2 rounded-lg @if (request()->routeIs('tv-shows')) bg-red-500/10 text-red-500 @endif">
                        <i class="fas fa-tv mr-2"></i>TV Shows
                    </a>
                    <a href="{{ route('anime') }}"
                        class="nav-link px-4 py-2 rounded-lg @if (request()->routeIs('anime')) bg-red-500/10 text-red-500 @endif">
                ...
                <div class="flex items-center gap-3 flex-1 justify-end">
                    ...
                    <div class="hidden md:block relative max-w-md w-full">
                        <div class="relative flex items-center">
                            <input type="text" id="liveSearch" placeholder="Search anything..." autocomplete="off"
                            ...
                            <i
                                class="fas fa-search absolute left-4 top-1/2 -translate-y-1/4 text-gray-500 pointer-events-none"></i>
                            <a href="{{ route('search') }}"
                        ...
                        <div id="searchResults"
                            class="hidden absolute top-full left-0 right-0 mt-2 bg-gray-800/95 backdrop-blur-xl border border-gray-700/50 rounded-xl shadow-2xl max-h-96 overflow-y-auto">
                            <div id="searchResultsContent" class="divide-y divide-gray-700/50"></div>
                            <a href="{{ route('search') }}"
                                class="block p-4 text-center text-sm text-gray-400 hover:text-red-500 hover:bg-gray-700/50 transition-colors">
                    ...
                    <button onclick="toggleMobileSearch()"
                        class="md:hidden p-2 text-gray-400 hover:text-white hover:bg-gray-800 rounded-lg transition-all">
                        <i class="fas fa-search text-lg"></i>
                    </button>

                    <!-- Mobile Menu Toggle -->
                    <button onclick="toggleMobileMenu()"
                        class="lg:hidden p-2 text-gray-400 hover:text-white hover:bg-gray-800 rounded-lg transition-all">
            ...
            <div id="mobileMenu" class="hidden lg:hidden mt-4 pb-2 border-t border-gray-800/50 pt-4">
                <div class="flex flex-col space-y-2">
                    <a href="{{ route('home') }}"
                        class="flex items-center px-4 py-2.5 rounded-lg text-gray-400 hover:text-white hover:bg-gray-800/50 transition-all @if (request()->routeIs('home')) bg-red-500/10 text-red-500 @endif">
                        <i class="fas fa-home w-6"></i>
                        <span>Home</span>
                    </a>
                    <a href="{{ route('movies') }}"
                        class="flex items-center px-4 py-2.5 rounded-lg text-gray-400 hover:text-white hover:bg-gray-800/50 transition-all @if (request()->routeIs('movies')) bg-red-500/10 text-red-500 @endif">
                        <i class="fas fa-film w-6"></i>
                        <span>Movies</span>
                    </a>
                    <a href="{{ route('tv-shows') }}"
                        class="flex items-center px-4 py-2.5 rounded-lg text-gray-400 hover:text-white hover:bg-gray-800/50 transition-all @if (request()->routeIs('tv-shows')) bg-red-500/10 text-red-500 @endif">
                        <i class="fas fa-tv w-6"></i>
                        <span>TV Shows</span>
                    </a>
                    <a href="{{ route('anime') }}"
                        class="flex items-center px-4 py-2.5 rounded-lg text-gray-400 hover:text-white hover:bg-gray-800/50 transition-all @if (request()->routeIs('anime')) bg-red-500/10 text-red-500 @endif">
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8 mb-8">
                ...
                <div class="lg:col-span-1">
                    <div class="flex items-center space-x-3 mb-4 group">
                        <div
                            class="w-10 h-10 bg-gradient-to-br from-red-600 via-red-500 to-orange-500 rounded-xl flex items-center justify-center shadow-lg group-hover:shadow-red-500/50 transition-all duration-300">
                            <i class="fas fa-play text-white text-lg"></i>
                        </div>
                        <span
                            class="text-2xl font-bold bg-gradient-to-r from-white to-gray-300 bg-clip-text text-transparent">iNeedCinema</span>
                    </div>
                ...
                <div>
                    ...
                    <ul class="space-y-3">
                        <li><a href="{{ route('movies') }}"
                                class="text-gray-400 hover:text-red-500 transition-colors duration-200 flex items-center group">
                                <i
                                    class="fas fa-chevron-right text-xs mr-2 opacity-0 group-hover:opacity-100 transition-opacity"></i>
                                Movies
                            </a></li>
                        <li><a href="{{ route('tv-shows') }}"
                                class="text-gray-400 hover:text-red-500 transition-colors duration-200 flex items-center group">
                                <i
                                    class="fas fa-chevron-right text-xs mr-2 opacity-0 group-hover:opacity-100 transition-opacity"></i>
                                TV Shows
                            </a></li>
                        <li><a href="{{ route('anime') }}"
                                class="text-gray-400 hover:text-red-500 transition-colors duration-200 flex items-center group">
                                <i
                                    class="fas fa-chevron-right text-xs mr-2 opacity-0 group-hover:opacity-100 transition-opacity"></i>
                                Anime
                ...
                <div>
                    ...
                    <div class="text-gray-400 text-sm leading-relaxed space-y-2">
                        <p>
                            iNeedCinema does not host any files on its servers. All content is provided by third-party
                            services.
                        </p>
                        <p>
                            We do not own, produce, or distribute any movies, TV shows, or anime displayed on this
                            website.
                        </p>
            ...
            <div class="border-t border-gray-800/50 pt-8">
                <div class="flex flex-col sm:flex-row justify-between items-center gap-4">
                    ...
                    <div class="flex flex-wrap items-center justify-center gap-4 text-xs">
                        <a href="{{ route('terms') }}"
                            class="text-gray-500 hover:text-red-500 transition-colors">Terms of Service</a>
                        <span class="text-gray-700">•</span>
                        <a href="{{ route('privacy') }}"
                            class="text-gray-500 hover:text-red-500 transition-colors">Privacy Policy</a>
                    </div>
                </div>
            </div>
        </div>
    ...
    <script>
        ...
        function displaySearchResults(results) {
            ...
            if (movies.length > 0) {
                html +=
                    '<div class="p-3 bg-gray-700/30"><div class="text-xs font-semibold text-gray-400 uppercase"><i class="fas fa-film mr-2"></i>Movies</div></div>';
                movies.forEach(item => {
            ...
            if (tvShows.length > 0) {
                html +=
                    '<div class="p-3 bg-gray-700/30"><div class="text-xs font-semibold text-gray-400 uppercase"><i class="fas fa-tv mr-2"></i>TV Shows</div></div>';
            ...
            if (anime.length > 0) {
                html +=
                    '<div class="p-3 bg-gray-700/30"><div class="text-xs font-semibold text-gray-400 uppercase"><i class="fas fa-dragon mr-2"></i>Anime</div></div>';
                anime.forEach(item => {
                    const poster = item.poster_path ? `https://image.tmdb.org/t/p/w92${item.poster_path}` :
                        '/images/placeholder-poster.jpg';
                    const year = item.first_air_date ? new Date(item.first_air_date).getFullYear() : '';
